...
def getResultGOES_new(img_list, index, point, crs_prefix, city_export, filename, verbose=False):
    """
    ...
    Args:
        ...
        point (ee.Geometry.Point): Central point of image, with which to create a buffered export region around.
        crs_prefix (str): String of the first three number of an EPSG code. '326' For northern hemisphere or '327' for southern hemisphere.
        city_export (tuple-like): Tuple of [UTM zone number, utm x coordinate, utm y coordinate] giving city export parameters
